use super::{
	...
	Runtime, RuntimeCall, RuntimeEvent, RuntimeOrigin, WeightToFeeLunes, XcmpQueue,
};
...
impl xcm_executor::Config for XcmConfig {
	...
	type Trader =
		UsingComponents<WeightToFeeLunes, RelayLocation, AccountId, Balances, ToAuthor<Runtime>>;
